...
public class Var_01 {
	public static void main(String[] args) {
		...
		// 1 ~ 1000 까지 범위중 임의의 수 1개를 생성하여 intNum1 에 저장
		int intNum1 = (int)(Math.random() * 1000) + 1;
		int intNum2 = (int)(Math.random() * 1000) + 1;
		
		System.out.printf("int Num1 : %d\n", intNum1);
		System.out.printf("int Num2 : %d\n", intNum2);
		 ...
		 * 정확히 일치하지 않으면 true,
		 * 두개의 비교대상이 같지 않냐? 라고 묻는 것
		 */
		System.out.println("num1 != num2 " + (intNum1 != intNum2));//<>로 표현하는 언어도 많지만 자바는 !=
