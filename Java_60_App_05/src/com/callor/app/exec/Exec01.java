 ...
 * 
 * insert 정렬, bubble 정렬, selection 정렬, Quick 정렬, merge 정렬, shell 정렬,
 * Radix 정렬 알고리즘이 있다
 * 
 ...
 * (간단한 프로그래밍을 할 때는 많이 사용된다)
 * 
 * 전체 배열이나 리스트를 for() 문으로 반복하면서
 * 0번 위치와 1 ~ 끝위치까지 비교하면서 큰 값은 오른쪽으로 
 * 		작은 값은 왼쪽으로
 ...
 * 큰 데이터가 아닐경우는 insert 정렬에 비해 더 빠르다(선생님 테스트 결과)
 */
public class Exec01 {
