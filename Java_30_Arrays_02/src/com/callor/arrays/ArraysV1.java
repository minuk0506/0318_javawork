...
public class ArraysV1 {
	public static void main(String[] args) {
		...
		// 정수형 배열 intNums 를 선언하고, 공간10개를 확보하라
		// 정수형 배열 10개짜리 intNums 를 생성하라
		// 정수형 배열 intNums에는 정수를 10개 저장할 수 있는
		// 		저장공간이 생성된다.
		...
		intNums[3] = 40;
		intNums[4] = 50;
		// intNums[5] 부터 intNums[8]까지는 0으로  clear 된 상태 유지
		intNums[9] = 100;
		 ...
		 * print(method()) : method() 실행하고 return 된 결과를 console 에 출력
		 * 		단, method()가 void type 인 경우는 오류가 난다.
		 * 
		 * print(객체, 인스턴스) : 
		 * 		객체.toString(), 인스턴스.toString() 을 먼저 실행하고
