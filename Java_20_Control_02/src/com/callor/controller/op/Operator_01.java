...
public class Operator_01 {
	public static void main(String[] args) {
		 ...
		 * 명령문의 시작은 key word 와 변수만 올 수 있다
		...
		// 대입연산자 : 리터럴 100을 변수 intNum2에 대입하라(저장하라)
		intNum2 = 100;
		...
		intNum2++; // int Num2 를 1 증가시켜라 System.out.println(intNum2);
		System.out.println(intNum2);
		
		// 대입연산자
		intNum2 = ++intNum1; // intNum1 을 1 증가시키고 결과를 intNum2에 저장
		System.out.println(intNum2);

		// 대입연산자
		intNum1 = intNum1 + 10; // intNum1 의 값을 10 증가시켜라 intNum2 = intNum1; // intNum1 에 저장된 값을 intNum2에 복사하라
		System.out.println(intNum2);
