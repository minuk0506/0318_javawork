...
public class Boolean_01 {
	public static void main(String[] args) {
		...
		boolean bGT = intNum1 > intNum2; // greater than html에서 <p>&gt</p> - >가 출력됨
		boolean bLT = intNum1 < intNum2; // less than	<p>&lt</p> - <가 출력됨
		 ...
		 * 서로 다른지 비교를 한다. 당연히 같지 않으면 bNotEq 가 true가 될 것이고
